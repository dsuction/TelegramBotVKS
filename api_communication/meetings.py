from api_requests import get_request, post_request, delete_request
...
"""
def create_meetings(attachments: list[str], name: str, room_id: int, comment: str, participants_count: int, send_notifications_at,
                    is_microphone_on: bool, is_video_on: bool, is_waiting_room_enabled: bool, need_video_recording: bool, need_video_recording_2: bool,
                    external_url: str, permanent_room_id: int, started_at, ended_at, duration: int, is_governo_presents: bool, is_notify_accepted: bool,
                    id_1: int, email: str, last_name: str, first_name: str, middle_name: str, id_2: int, frequency: int, started_at_2, interval: int, count: int,
                    until, week_days: list[int], additional_dates: list, exclude_dates: list, recurrence_update_type: str, is_virtual: bool, state: str, 
